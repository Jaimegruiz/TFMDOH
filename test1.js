var baseDomain = "XXXXXX";
var idCampaign = "YYYYYY";
  ...
  list.getEntries().forEach((entry) => {
    ...
    if (entryName.includes(baseDomain)) {
      ...
      if (entryName.includes("name=")) {
        aux = entryName.split("name=")[1];
        firstChar = aux[1];
        var estimatedDuration = 0;

        if (entryName.includes("dns.google")) {
          if (isNaN(firstChar)) {
            estimatedDuration = googleTiming2;
          } else {
            estimatedDuration = googleTiming;
          }
        } else if (entryName.includes("cloudflare")) {
          if (isNaN(firstChar)) {
            estimatedDuration = cloudflareTiming2;
          } else {
            estimatedDuration = cloudflareTiming;
          }
        } else if (entryName.includes("doh.dns.sb")) {
          if (isNaN(firstChar)) {
            estimatedDuration = dnsSBTiming2;
          } else {
            estimatedDuration = dnsSBTiming;
          }
        } else if (entryName.includes("dns.quad9.net")) {
          if (isNaN(firstChar)) {
            estimatedDuration = quad9Timing2;
          } else {
            estimatedDuration = quad9Timing;
          }
        }
...
async function runTests() {
  ...
  fetch("https://" + idAd + ".min." + baseDomain)
    ...
    .then(function (myJson) {
      ...
      fetch("https://" + "x" + idAd + ".min." + baseDomain)
        .then(function () {
  ...
  let google_two =
    "https://dns.google/resolve?name=gg" + idAd + "." + baseDomain + "&type=A";

  let cloud_one =
    "https://cloudflare-dns.com/dns-query?name=c" +
    idAd +
    "." +
    baseDomain +
    "&type=A";
  let cloud_two =
    "https://cloudflare-dns.com/dns-query?name=cc" +
    idAd +
    "." +
    baseDomain +
    "&type=A";
  let quad9_one =
    "https://dns.quad9.net:5053/dns-query?name=q" +
    idAd +
    "." +
    baseDomain +
    "&type=A";
  let quad9_two =
    "https://dns.quad9.net:5053/dns-query?name=qq" +
    idAd +
    "." +
    baseDomain +
    "&type=A";
  ...
  let dnsSB_two =
    "https://doh.dns.sb/dns-query?name=dd" +
    idAd +
    "." +
    baseDomain +
    "&type=A";
  ...
  fetch(googleRequest).then(async function (result) {
    ...
    sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "Google", Pos: 1 }))
    ...
    fetch(googleRequest2).then(async function (result) {
      ...
      let data = await result.json();
      sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "Google", Pos: 2 }))
  ...
  fetch(cloudRequest).then(async function (result) {
    ...
    let data = await result.json();
    sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "Cloudflare", Pos: 1 }))
    ...
    fetch(cloudRequest2).then(async function (result) {
      ...
      let data = await result.json();
      sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "Cloudflare", Pos: 2 }))
    });
    sentQueries.push(8)
  ...
  fetch(quad9Request).then(async function (result) {
    ...
    let data = await result.json();
    sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "Quad9", Pos: 1 }))
    ...
    fetch(quad9Request2).then(async function (result) {
      ...
      let data = await result.json();
      sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "Quad9", Pos: 2 }))
    });
    sentQueries.push(9)
  ...
  fetch(dnsSBRequest).then(async function (result) {
    ...
    let data = await result.json();
    sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "DNSSB", Pos: 1 }))
    ...
    fetch(dnsSBRequest2).then(async function (result) {
      ...
      let data = await result.json();
      sendData(JSON.stringify({ Type: 6, DohResult: JSON.stringify(data), Res: "DNSSB", Pos: 2 }))
    });
    sentQueries.push(10)
